...
import FlavoredCoffeData from '../../api/FlavoredCoffeData.json';
import * as GoIcons from 'react-icons/go';
import Popup from '../Popup';

const FlavoredCoffeMenu = () => {
  ...
  const RenderItem = FlavoredCoffeData.map((item, index) => {
    return (
...
export default FlavoredCoffeMenu;
